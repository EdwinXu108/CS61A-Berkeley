...
def count_change(total):
    ...
    '''
    --- Backtracking Method with for loop---
    ...
    def backtracking(remaining, startIndex):
        nonlocal count
        ...
        for i in range(startIndex, len(coins)):
            coin = coins[i]
            backtracking(remaining - coin, i)
    
    backtracking(total, 0)
    return count
    '''
    count = 0
    def helper(remaining, coin):
        ...
        helper(remaining, coin * 2)
        helper(remaining - coin, coin)
